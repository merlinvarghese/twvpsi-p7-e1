...
class RectangleTest {
    ...
    void expectArea20ForLength5Width4() {
        Rectangle calculator = Rectangle.createRectangle(5,4);
        Assertions.assertEquals(20, calculator.area());
    }

    @Test
    void expectArea12ForLength4Width3() {
        Rectangle calculator = Rectangle.createRectangle(4, 3);
    ...
    void expectPerimeter24ForLenght8Width4() {
        Rectangle calculator = Rectangle.createRectangle(8, 4);
